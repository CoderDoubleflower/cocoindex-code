...
from cocoindex_code.settings import EmbeddingSettings, UserSettings, find_parent_with_marker, save_user_settings
...
def e2e_env() -> Iterator[Path]:
    ...
    save_user_settings(UserSettings(embedding=EmbeddingSettings(provider="test", model="deterministic")))
