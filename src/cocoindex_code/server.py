...
def main() -> None:
    ...
    if not user_file.is_file():
        ...
        env_api_base = os.environ.get("COCOINDEX_CODE_API_BASE", "").strip()
        if env_api_base:
            us.embedding.api_base = env_api_base

        env_encoding_format = os.environ.get("COCOINDEX_CODE_ENCODING_FORMAT", "").strip()
        if env_encoding_format:
            us.embedding.encoding_format = env_encoding_format
